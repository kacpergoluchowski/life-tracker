    ...
    return (
        <div className="absolute right-0 top-0 w-2/5 h-full py-24 text-center md:sticky md:w-full md:py-6">
            ...
            <div className="h-5/6 mt-12 py-5 flex justify-center items-center flex-col gap-y-4">
                <input type = 'text' className="w-1/2 h-16 rounded-3xl text-2xl px-5 bg-slate-200 md:bg-white md:w-4/5 md:h-16" placeholder="Enter your nickname"/>
                <input type = 'text' className="w-1/2 h-16 rounded-3xl text-2xl px-5 bg-slate-200 md:bg-white md:w-4/5 md:h-16" placeholder="Enter your password"/>
                <button className="bg-blue-300 w-1/2 h-12 text-3xl rounded-3xl hover:bg-blue-400 md:w-4/5"> Login </button>
