        ...
        <section className="bg-gradient-to-br from-amber-200 to-amber-300 w-1/3 h-4/6 py-5 px-5 rounded-3xl md:w-full md:h-screen"> 
            ...
            <div className="mt-10">
                <div className="flex flex-col">
                    ...
                    <input type = 'text' placeholder="Enter your username" className="w-5/6 h-12 rounded-3xl px-5 font-Tsukimi md:w-full"/>
                </div>
                <div className="flex flex-col mt-5">
                    <span className="text-2xl ml-4 font-Tsukimi"> Password </span>
                    <input type = 'password' placeholder="Enter your password" className="w-5/6 h-12 rounded-3xl px-5 font-Tsukimi md:w-full"/>
